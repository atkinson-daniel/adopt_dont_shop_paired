...
RSpec.describe PetApplication do
  ...
  describe "#approve_application" do
    it "can approve an application" do
      ...
      expect(pet_app[:approved]).not_to eq(true)

      pet_app.approve_application

      expect(pet_app[:approved]).to eq(true)
    end
  end

  describe "#pet_app_create" do
    it "creates a PetApplication from a given application and pet" do
      ...
      expect(PetApplication.pet_app_create(application, pet)).to be_a PetApplication
    end
  end
end
